        ...
        private static void ExceptionHandler(Exception e)
        {
            ...
            try
            {
                ...
                string swVersion = Application.ProductVersion + " Build Date: " + 
                    System.IO.File.GetLastWriteTime(Application.ExecutablePath).ToCSTTime().ToString("yyyy-MM-dd HH:mm:ss") + 
                    "    " + runingBit  + 
                ...
                LogStackTrace(path + ".txt", swVersion + "    " + 
                    "this is test expFile" + "    " + 
                    "this is test sample" + "\r\n\r\n" + msg);

                if (SystemInformation.UserInteractive)
                {
                    using (ThreadExceptionDialog dialog = new ThreadExceptionDialog(e))
                    {
