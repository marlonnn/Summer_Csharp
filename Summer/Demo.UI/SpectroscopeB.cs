...
namespace Demo.UI
{
    public partial class SpectroscopeB : UserControl
    {
        ...
        private void DrawTrapezoid(PaintEventArgs e)
        {
            ...
            PointF point2 = new PointF(this.Width - 20, this.Width - 20);
            PointF point3 = new PointF(this.Width - 20, this.Width * 7 / 8 - 20);
            PointF point4 = new PointF(this.Width / 8 + 20, 20);
            PointF[] curvePoints =
            {
                 point1,
                 point2,
